...
- **밝기/대비 및 Flip**
  ...
  - 좌우 반전(Flip) 토글
- **오버레이 UI**
  - 상단 파스텔 핑크 바: PREVIEW/RECORD 텍스트 + 상단 메뉴(REC, Shot, Flip, Filter, Help, Exit)
  - 하단 도움말: 단축키 안내 (토글 가능)
...
3. **결과 파일 확인**
   ...
   - 파일명 예시: `record_20260312_153045.mp4`
...
과제 제출 시 다음과 같이 **실행 화면 스크린샷 또는 녹화 예시 동영상**을 이 저장소에 함께 추가하는 것을 권장합니다.

- 예시 파일 이름
  - `screenshot_main_ui.png`
  - `sample_recording.mp4`

> 채점 기준에 맞추기 위해, README와 스크린샷/동영상, 저장소 설명(description)을 꼭 채워서 제출하세요.
